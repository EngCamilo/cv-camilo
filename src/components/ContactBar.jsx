...
export default function ContactBar() {
  ...
  return (
    <section className="bg-white shadow-sm py-4 border-b fixed top-0 w-full z-40">
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row xl:flex-wrap justify-center md:justify-between items-center gap-2 xl:gap-4 text-sm text-gray-700">
