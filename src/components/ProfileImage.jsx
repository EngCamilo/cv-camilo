...
export default function ProfileImage() {
  return (
    <div className="absolute left-36 md:left-1/3 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
        ...
        <img
            src="https://photos.google.com/share/AF1QipPF5L05HsjXxPti7hQay8vdpA1sspDhsXCc6HhdHMQ-YK8rtUIM7bHxEu22oZWzaQ/photo/AF1QipMBt3NS9D6i4ULro74QhgAcMSxvIWHh8gzSqbNG?key=bjdSMWNjN053bWdobW9VT3VHWkY1M2NFcHQ2d05R"
            alt="Foto de perfil"
